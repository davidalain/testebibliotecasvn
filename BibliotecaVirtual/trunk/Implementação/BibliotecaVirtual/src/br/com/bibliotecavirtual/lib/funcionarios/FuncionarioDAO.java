...
public class FuncionarioDAO implements IFuncionarioDAO {
	...
	public void atualizar(Funcionario funcionario) throws SQLException {
		...
		parametros.add(cpf);
		parametros.add(cpf);
		conexao.executeNonQuery(MAPEAMENTO, FuncionarioDAO.ATUALIZAR,
				parametros);
	...
	public void inserir(Funcionario funcionario) throws SQLException {
		...
		parametros.add(nome);
		parametros.add(cpf);
		this.conexao.executeNonQuery(MAPEAMENTO, FuncionarioDAO.INSERIR,
				parametros);
	}
	...
	public Funcionario buscarPorMatricula(String matricula) throws SQLException {
		...
		ResultSet rs = conexao.executeQuery(MAPEAMENTO,
				FuncionarioDAO.BUSCAR_POR_MATRICULAR, parametros);
		Funcionario funcionarioRetorno = null;
		if (rs.next()) {
			funcionarioRetorno = new Funcionario(rs.getString("NOME"), rs
					.getString("matricula"), rs.getInt("ID"));
		}
	...
	public void remover(String matricula) throws SQLException {
		ArrayList<Object> parametros = new ArrayList<Object>();
		parametros.add(matricula);
		this.conexao.executeNonQuery(MAPEAMENTO, FuncionarioDAO.REMOVER,
				parametros);
	...
	public Funcionario buscarPorID(int id) throws SQLException {
		...
		parametros.add(id);
		ResultSet rs = conexao.executeQuery(MAPEAMENTO,
				FuncionarioDAO.BUSCAR_POR_ID, parametros);
		Funcionario funcionarioRetorno = null;
		if (rs.next()) {
			funcionarioRetorno = new Funcionario(rs.getString("NOME"), rs
					.getString("matricula"), rs.getInt("ID"));
