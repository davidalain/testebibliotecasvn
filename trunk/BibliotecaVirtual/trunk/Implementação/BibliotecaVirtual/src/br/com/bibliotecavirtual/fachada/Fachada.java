package br.com.bibliotecavirtual.fachada;
...
import br.com.bibliotecavirtual.lib.devolucoes.Devolucao;
...
public class Fachada {
	...
	public void devolver(Aluguel aluguel, Funcionario funcionario)
			throws SQLException, ParseException {
		Devolucao novaDevolucao = new Devolucao();

		Data dataDevolucao = new Data(new Date().toString());

		novaDevolucao.setFuncionario(funcionario);

		novaDevolucao.setData(dataDevolucao);

		this.controladorDevolucao.devolver(novaDevolucao);
	}

	public void renovar(Aluguel aluguel, Funcionario funcionario)
			throws SQLException, ParseException, ExemplarNaoDisponivelException {
		this.devolver(aluguel, funcionario);
		this.alugar(aluguel.getAluno(), funcionario, aluguel.getExemplar());
	}
}
